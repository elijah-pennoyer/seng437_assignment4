...
public class NullArrayContentsTest {
	...
	/**
	 * Test Plan Coverage: calculateColumnTotal test for an array containing null values
	 * Test Strategy Coverage: Given array contains null values
	 * Description: Tests the calculateColumnTotal function when presented with an array containing null values
	 * Expected Output: 0.0
	 * Assumptions: Null values in the input array do not increment or decrement the column total
	 */
	@Test
	public void calculateColumnTotal_arrayContainingNull_Test() {
